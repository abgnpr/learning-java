...
public class BalancedBrackets {
    ...
    public static void main(String[] args) {
        check("separate pairs", "{}()[]", true, isBalanced("{}()[]"));
        check("nested pairs", "({[]})", true, isBalanced("({[]})"));
        check("crossed pairs", "([)]", false, isBalanced("([)]"));
        check("unclosed pair", "((", false, isBalanced("(("));
        check("empty text", "", true, isBalanced(""));
        report("Challenge 35");
    }
