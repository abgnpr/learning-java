...
public class DistinctPairs {
    ...
    public static void main(String[] args) {
        check("duplicate pair", "\"john\", \"tom\"", List.of(1, 2, 2), runningDistinctCounts(List.of(
                new Pair("john", "tom"),
                new Pair("john", "mary"),
                new Pair("john", "tom")
            )));
        check("pair order matters", "\"a\", \"b\"", List.of(1, 2), runningDistinctCounts(List.of(new Pair("a", "b"), new Pair("b", "a"))));
        check("empty input", "List.of()", List.of(), runningDistinctCounts(List.of()));
        report("Challenge 36");
    }
