...
public class DistinctWindow {
    ...
    public static void main(String[] args) {
        check("mixed windows", "new int[] { 5, 3, 5, 2, 3, 2 }, 3", 3, maxDistinctInWindow(new int[] { 5, 3, 5, 2, 3, 2 }, 3));
        check("all duplicates", "new int[] { 7, 7, 7, 7 }, 2", 1, maxDistinctInWindow(new int[] { 7, 7, 7, 7 }, 2));
        check("whole array window", "new int[] { 1, 2, 3 }, 3", 3, maxDistinctInWindow(new int[] { 1, 2, 3 }, 3));
        report("Challenge 40");
    }
