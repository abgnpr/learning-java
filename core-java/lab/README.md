...
| 19 — Java String Tokens | Unicode categories in regex: `\p{L}`/`\P{L}`, and matching per code point rather than per `char` | [Java 21 API — `java.util.regex.Pattern`](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/regex/Pattern.html) | 2026-09-16 |
| 19 — Java String Tokens | Supplementary characters: why `Character.isLetter(char)` fails on a surrogate half and the `int` overload does not | [Java 21 API — `java.lang.Character`](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Character.html#unicode) | 2026-09-16 |
| 19 — Java String Tokens | `split`'s trailing-vs-leading empty fields, and `splitAsStream` as the lazy form | [Baeldung — Split a String in Java](https://www.baeldung.com/java-split-string) | 2026-09-16 |
