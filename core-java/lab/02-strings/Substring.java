...
public final class Substring {
    ...
    public static void main(String[] args) {
        check("middle slice", "\"encyclopedia\", 2, 7", "cyclo", slice("encyclopedia", 2, 7));
        check("whole string", "\"Java\", 0, 4", "Java", slice("Java", 0, 4));
        check("empty slice", "\"abc\", 2, 2", "", slice("abc", 2, 2));
        report("Challenge 15");
    }
