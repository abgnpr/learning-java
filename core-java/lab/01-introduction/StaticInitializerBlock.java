...
public final class StaticInitializerBlock {
    ...
    public static void main(String[] args) {
        check("default width", "Defaults.width", 7, Defaults.width);
        check("default height", "Defaults.height", 5, Defaults.height);
        check("computed area", "Defaults.area", 35, Defaults.area);
        report("Challenge 10");
    }
