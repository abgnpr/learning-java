...
public final class DateAndTime {
    ...
    public static void main(String[] args) {
        check("millennium date", "2000, 1, 1", "SATURDAY", dayOfWeek(2000, 1, 1));
        check("leap day", "2024, 2, 29", "THURSDAY", dayOfWeek(2024, 2, 29));
        check("future date", "2030, 12, 25", "WEDNESDAY", dayOfWeek(2030, 12, 25));
        report("Challenge 12");
    }
