...
public class ReflectionMethodNames {
    ...
    public static void main(String[] args) {
        check("student methods", "Student.class", List.of("getEmail", "getId", "getName"), declaredMethodNames(Student.class));
        check("declared methods exclude inherited methods", "ChildFixture.class", List.of("ownMethod"), declaredMethodNames(ChildFixture.class));
        check("class with no methods", "EmptyFixture.class", List.of(), declaredMethodNames(EmptyFixture.class));
        report("Challenge 54");
    }
