...
public class OverloadedPrimeChecker {
    ...
    public static void main(String[] args) {
        ...
        check("one prime", "checker.checkPrime(2)", "2", checker.checkPrime(2));
        check("one prime among three values", "checker.checkPrime(1, 2, 4)", "2", checker.checkPrime(1, 2, 4));
        check("three primes among five values", "checker.checkPrime(5, 7, 8, 9, 11)", "5 7 11", checker.checkPrime(5, 7, 8, 9, 11));
        report("Challenge 56");
    }
