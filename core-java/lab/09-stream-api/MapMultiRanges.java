...
public final class MapMultiRanges {
    ...
    public static void main(String[] args) {
        check("mixed ranges", "1, 3", List.of(1, 2, 3, 7, 9, 10), expand(List.of(new IntRange(1, 3), new IntRange(7, 7),
                        new IntRange(5, 2), new IntRange(9, 10))));
        check("negative range", "-2, 0", List.of(-2, -1, 0), expand(List.of(new IntRange(-2, 0))));
        check("empty input", "List.of()", List.of(), expand(List.of()));
        report("Challenge 69");
    }
