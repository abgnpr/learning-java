...
public final class JoiningCollector {
    ...
    public static void main(String[] args) {
        check("normalized tags", "List.of(\" Java \", \"\", \"STREAMS\", \"java\")", "[java, streams, java]", formatTags(List.of(" Java ", "", "STREAMS", "java")));
        check("single tag", "List.of(\"one\")", "[one]", formatTags(List.of("one")));
        check("no usable tags", "List.of(\" \", \"\\t\")", "[]", formatTags(List.of(" ", "\t")));
        report("Challenge 75");
    }
