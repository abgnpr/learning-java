...
public final class TeeingRange {
    ...
    public static void main(String[] args) {
        check("mixed values", "List.of(3, 12, -4, 7)", Optional.of(new Range(-4, 12)), range(List.of(3, 12, -4, 7)));
        check("single value", "List.of(5)", Optional.of(new Range(5, 5)), range(List.of(5)));
        check("empty input", "List.of()", Optional.empty(), range(List.of()));
        report("Challenge 79");
    }
