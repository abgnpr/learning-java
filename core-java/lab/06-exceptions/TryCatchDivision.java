...
public class TryCatchDivision {
    ...
    public static void main(String[] args) {
        check("integer division", "10 3", "3", evaluate("10 3"));
        check("division by zero", "10 0", "java.lang.ArithmeticException: / by zero", evaluate("10 0"));
        check("non-integer input", "ten 3", InputMismatchException.class.getName(), evaluate("ten 3"));
        report("Challenge 51");
    }
