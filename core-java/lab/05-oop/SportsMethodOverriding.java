...
public class SportsMethodOverriding {
    ...
    public static void main(String[] args) {
        ...
        check("overridden name via base reference", "sport.name()", "Soccer", sport.name());
        check("soccer team size via dynamic dispatch", "sport.teamSize()", 11, sport.teamSize());
        check("soccer team size via subtype reference", "new Soccer().teamSize()", 11, new Soccer().teamSize());
        report("Challenge 47");
    }
