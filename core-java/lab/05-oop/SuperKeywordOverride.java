...
public class SuperKeywordOverride {
    ...
    public static void main(String[] args) {
        check("base description remains available", "new Cycle().description()", "a vehicle with pedals", new Cycle().description());
        check("subclass description", "new Motorcycle().description()", "a cycle with an engine; ancestor: a vehicle with pedals", new Motorcycle().description());
        Cycle polymorphic = new Motorcycle();
        check("polymorphic description", "polymorphic.description()", "a cycle with an engine; ancestor: a vehicle with pedals", polymorphic.description());
        report("Challenge 48");
    }
