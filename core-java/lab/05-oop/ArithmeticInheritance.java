...
public class ArithmeticInheritance {
    ...
    public static void main(String[] args) throws ReflectiveOperationException {
        checkThat("Adder must be a subtype of Arithmetic", "Arithmetic.class.isAssignableFrom(Adder.class)", Arithmetic.class.isAssignableFrom(Adder.class));
        check("positive operands", "invokeAdd(new Adder(), 2, 5)", 7, invokeAdd(new Adder(), 2, 5));
        check("mixed-sign operands", "invokeAdd(new Adder(), -8, 5)", -3, invokeAdd(new Adder(), -8, 5));
        check("zero operands", "invokeAdd(new Adder(), 0, 0)", 0, invokeAdd(new Adder(), 0, 0));
        report("Challenge 44");
    }
