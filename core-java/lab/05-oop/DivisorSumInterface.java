...
public class DivisorSumInterface {
    ...
    public static void main(String[] args) {
        ...
        check("divisors of 1", "calculator.divisorSum(1)", 1, calculator.divisorSum(1));
        check("divisors of 6", "calculator.divisorSum(6)", 12, calculator.divisorSum(6));
        check("divisors of 28", "calculator.divisorSum(28)", 56, calculator.divisorSum(28));
        report("Challenge 46");
    }
