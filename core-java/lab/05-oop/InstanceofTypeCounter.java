...
public class InstanceofTypeCounter {
    ...
    public static void main(String[] args) {
        check("mixed group", "List.of(new Student(), new Rockstar(), new Student(), new Hacker())", new Counts(2, 1, 1), countTypes(List.of(new Student(), new Rockstar(), new Student(), new Hacker())));
        check("empty group", "List.of()", new Counts(0, 0, 0), countTypes(List.of()));
        check("group without students", "List.of(new Rockstar(), new Hacker(), new Rockstar())", new Counts(0, 2, 1), countTypes(List.of(new Rockstar(), new Hacker(), new Rockstar())));
        check("plain people are not counted as a subtype", "List.of(new Person(), new Student())", new Counts(1, 0, 0), countTypes(List.of(new Person(), new Student())));
        report("Challenge 49");
    }
