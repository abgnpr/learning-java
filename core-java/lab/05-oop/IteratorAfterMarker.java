...
public class IteratorAfterMarker {
    ...
    public static void main(String[] args) {
        check("strings after marker", "List.of(12, 0, \"###\", \"hello\", \"world\"), \"###\"", List.of("hello", "world"), elementsAfterMarker(List.of(12, 0, "###", "hello", "world"), "###"));
        check("numbers after marker", "List.of(1, \"stop\", 2, 3), \"stop\"", List.of(2, 3), elementsAfterMarker(List.of(1, "stop", 2, 3), "stop"));
        check("marker at end", "List.of(\"only\", \"marker\"), \"marker\"", List.of(), elementsAfterMarker(List.of("only", "marker"), "marker"));
        report("Challenge 50");
    }
