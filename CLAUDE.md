...
|---|---|---|---|
| `core-java.md` | OOP · collections · exceptions · Java 8+ · threads/JVM · traps · Spring/JDBC/REST · Kafka · SDLC/testing — **rapid-fire, answers sized for speaking** | §5→§4→§2→§3→§1 | 🟡 **6/9 sections at rep 1** — §5, §7, §8 unrepped (scorecard at the doc's foot is authoritative) |
