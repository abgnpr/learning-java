...
1. ✅ `notes/core-java.md` — rapid-fire core-Java kit (OOP ·
   collections · exceptions · Java 8+ · threads/JVM · Spring/JDBC/
   REST · Kafka · SDLC).
2. ✅ `notes/java-versions.md` — Java 7→25 timeline + the Tier-1
   "Java 8 from zero" study block.
3. ✅ `notes/s5-threads-lab.md` + `notes/lab-threads/` — 8 runnable
...
overlap `notes/spring-boot-basics.md` and `notes/kafka-basics.md`.
...
|---|---|---|---|
| `notes/core-java.md` | OOP · collections · exceptions · Java 8+ · threads/JVM · traps · Spring/JDBC/REST · Kafka · SDLC/testing — **rapid-fire, answers sized for speaking** | §5→§4→§2→§3→§1 | 🟡 racked (CBOI-built) |
| `notes/java-versions.md` | Java 7→25 timeline, headline feature + snippet each · LTS line 8/11/17/21/25 · **Tier-1 "Java 8 from zero" study block** (§A–§I) | timeline→§A–§I | 🟡 racked (CBOI-built) |
| `notes/s5-threads-lab.md` + `lab-threads/` | 8 runnable predict→run→explain stations: start/run · lost update · volatile · wait/sleep · deadlock · pools · producer-consumer · virtual threads | S1→S8 in order | 🟡 racked 2026-07-21, **0/8 stations repped** |
...
single-file launcher, no build: `cd notes/lab-threads && java
